...
class honeyCycle():
    ...
    def diskcheck(self):
        ...
        timeslice()
        print (TIMESTAMP, "honeyCycle <<< value of disk check exit code is", alertsize)
        if alertsize == 0:
            timeslice()
        ...
        timeslice()
        print (TIMESTAMP, "honeyCycle <<< value of disk check exit code is", alertsize2)
        if alertsize2 == 0:
            timeslice()
            print(TIMESTAMP, "honeyCycle <<< Disk size problem potential, clearing pcaps.")
            clearpcaps = 'rm -rf /opt/net-gargoyle/*.pcap'
        ...
        timeslice()
        print (TIMESTAMP, "honeyCycle <<< value of disk check exit code is", alertsize3)
        if alertsize3 == 0:
            timeslice()
